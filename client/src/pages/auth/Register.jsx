...
export default function Register() {
    ...
    async function onSubmitForm(event) {
        ...
        try {
            console.log("el address mawjouda ?", data)
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" placeholder='Ethereum wallet address' autoComplete='off' className='form-control' id="eth_address" ref={eth_address} />
                </div>
                <div className="mb-3">
